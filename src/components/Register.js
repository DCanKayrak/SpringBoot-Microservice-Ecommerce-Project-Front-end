            ...
            <div class="form-container">
                ...
                <form class="form">
                    <div class="input-group">
                        ...
                        <input onChange={event => setFirstName(event.target.value)} type="text" name="username" id="username" placeholder="" />
                    </div>
                    <div class="input-group">
                        <label for="username">Lastname</label>
                        <input onChange={event => setLastName(event.target.value)} type="text" name="username" id="username" placeholder="" />
                    </div>
                    <div class="input-group">
                        <label for="username">Phone Number</label>
                        <input onChange={event => setPhoneNumber(event.target.value)} type="text" name="username" id="username" placeholder="" />
                    </div>
                    <div class="input-group">
                    ...
                    <button onClick={() => handleRegister()} class="sign">Sign in</button>
                </form>
