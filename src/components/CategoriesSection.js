                                                        ...
                                                        <a href={'/product/' + product.slug}>
                                                            <div class="card">
                                                                ...
                                                                <div class="card-footer">
                                                                    ...
                                                                    <div class="card-price"><div className='card-oldPrice'><span className='text-lined'>{product.price} TL</span>- <span className='card-discount'>-%{product.discountRate}</span></div> {product.afterDiscount} <span>TL</span></div>
